...
public class Markers implements ClusterItem {
    ...
    // 방 고유 ID 저장
    String room_id; // UserID + createDate
    ...
    public Markers(double lat, double lng, String room_name_streamer, int resourceId, String room_id, int room_numpeople,
                   String room_name_title, String room_name_tag, String room_image_path, String room_status) {
