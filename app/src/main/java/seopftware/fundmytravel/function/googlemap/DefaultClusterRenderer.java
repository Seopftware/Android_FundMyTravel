...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private class RenderTask implements Runnable {
        ...
        @SuppressLint("NewApi")
        public void run() {
            if (clusters.equals(seopftware.fundmytravel.function.googlemap.DefaultClusterRenderer.this.mClusters)) {
                mCallback.run();
                return;
            }
            ...
            if (seopftware.fundmytravel.function.googlemap.DefaultClusterRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<T> c : seopftware.fundmytravel.function.googlemap.DefaultClusterRenderer.this.mClusters) {
...
//            com.google.maps.android.clustering.view.DefaultClusterRenderer.this.mClusters = clusters;
            seopftware.fundmytravel.function.googlemap.DefaultClusterRenderer.this.mClusters = clusters;
            mZoom = zoom;
